...
import {sortInt32} from '../dist/index.cjs';
...
const seed = [123, 456];
const {randomInt32} = entropy(seed);

let treference = new Int32Array(N);
fillfn(treference, 0, N, randomInt32);
